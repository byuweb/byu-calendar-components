...
gulp.task('watch', ['build'], function (done) {
  ...
  gulp.watch(['./demo/**', './byu-calendar/**', './byu-calendar-row/**', './byu-calendar-tile/**', './byu-calendar-feature-column/**', './byu-calendar-feature-links', './byu-calendar-minimal-tile/**'], ['build']);
});
